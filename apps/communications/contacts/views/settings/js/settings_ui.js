...
(function(exports) {
  ...
  function onOrderingChange(evt) {
    console.log('SETTINGS > UI > order change');
    console.log('before: ' + orderByLastName);
    console.log('now is: ' + orderCheckBox.checked);
    ...
    if(newOrderByLastName !== orderByLastName){
      ...
      console.log('> session stored: ' + 'null');
  ...
  function importHandler() {
    console.log('> SETTINGS > click on IMPORT');
  ...
  function exportHandler() {
    console.log('> SETTINGS > click on EXPORT');
  ...
  function addListeners() {
    ...
    document.getElementById('import-options').addEventListener('click', (e) => {
      console.log('> SETTINGS > UI > click - import');
    ...
    document.getElementById('export-options').addEventListener('click', (e) => {
      console.log('> SETTINGS > UI > click - export');
      console.log('event - ' + JSON.stringify(e.target));
...
// }
  ...
  function onImportDone(evt) {
    console.log('> SETTINGS UI > IMPORT > DONE');
    updateTimestamps();
    checkNoContacts();
  }
